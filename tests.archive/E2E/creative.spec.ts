...
/**
 * Creative Assets & Brief E2E Tests - Comprehensive Coverage
 *
 * This test suite covers all creative management functionality including:
 * - Creative assets library and management
 * - Creative brief creation with full fields
 * - Art direction and design specifications
 * - AI content generation
 * - Approval workflows
 * - Asset organization and search
 * - Brief templates and cloning
 * - Export and sharing
 */
test.describe('Creative Assets & Briefs', () => {
  ...
  test.describe('Creative Assets Library', () => {
  ...
  test.describe('Creative Brief Management', () => {
    ...
    test('should create basic creative brief', async ({ page }) => {
      await page.goto('/creative/briefs');
