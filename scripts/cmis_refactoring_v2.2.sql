...
BEGIN
    ...
    SELECT 
        CASE 
            WHEN EXISTS (SELECT 1 FROM pg_views WHERE schemaname = 'cmis' AND view_name = 'campaigns') THEN 'VIEW'
    ...
    SELECT 
        CASE 
            WHEN EXISTS (SELECT 1 FROM pg_views WHERE schemaname = 'cmis' AND view_name = 'integrations') THEN 'VIEW'
