...
<div class="container mx-auto px-4 py-6" x-data="userProfile()">
    <h1 class="text-2xl font-bold mb-6">{{ __('users.profile') }}</h1>
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="border-t pt-6"><h3 class="text-lg font-medium mb-4">{{ __('users.additional_info') }}</h3><dl class="space-y-3"><div><dt class="text-sm text-gray-500">{{ __('users.role') }}</dt><dd class="text-sm font-medium" x-text="user.role"></dd></div></dl></div>
    </div>
</div>
@push('scripts')
<script>
