                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div class="flex-1 overflow-y-auto p-6">
                        ...
                        <div x-show="composerTab === 'global'">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute bottom-2 start-2 end-2 flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button @click="showHashtagManager = true" class="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded" title="{{ __('publish.hashtags') }}">
                                            ...
                                            <button @click="showAIAssistant = true" class="p-1.5 text-blue-500 hover:text-blue-700 hover:bg-blue-50 rounded" title="{{ __('publish.ai_assistant') }}">
                            ...
                            {{-- Media Upload --}}
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('publish.media') }}</label>
                        ...
                        <template x-for="platform in getSelectedPlatforms()" :key="platform">
                            <div x-show="composerTab === platform">
                                ...
                                <div x-show="platform === 'instagram'" class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('publish.post_type') }}</label>
                                        <div class="flex gap-3">
                                            <label class="flex items-center">
                                                <input type="radio" x-model="content.platforms.instagram.post_type" value="feed" class="ms-2"> {{ __('publish.feed') }}
                                            </label>
                                            <label class="flex items-center">
                                                <input type="radio" x-model="content.platforms.instagram.post_type" value="reel" class="ms-2"> {{ __('publish.reel') }}
                                            </label>
                                            <label class="flex items-center">
                                                <input type="radio" x-model="content.platforms.instagram.post_type" value="story" class="ms-2"> {{ __('publish.story') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('publish.first_comment') }}</label>
                            ...
                            <template x-if="scheduleEnabled">
                                <div class="flex items-center gap-3">
                                    ...
                                    <button @click="showBestTimes = true" class="px-3 py-1.5 text-sm text-blue-600 hover:text-blue-700">
                                        <i class="fas fa-clock ms-1"></i>{{ __('publish.best_times') }}
                                    </button>
                                </div>
                            </template>
                        </div>
