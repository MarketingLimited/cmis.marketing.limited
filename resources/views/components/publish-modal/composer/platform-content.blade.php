    ...
    <div x-show="composerTab === platform">
        <div class="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p class="text-sm text-yellow-800">
                ...
                {{ __('publish.customize_for_platform', ['platform' => '']) }}<span x-text="getPlatformTabName(platform)" class="font-semibold"></span>.
            </p>
        </div>
        ...
        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <span x-text="getPlatformTabName(platform) + ' {{ __('publish.post_content') }}'"></span>
            </label>
            <textarea x-model="content.platforms[platform].text" rows="5"
                      :placeholder="'{{ __('publish.custom_content_for', ['platform' => '']) }}' + getPlatformTabName(platform) + '...'"
