...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('password.update') }}" method="POST">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700">{{ __('auth.new_password_label') }}</label>
                <input
                    id="password"
                    name="password"
                    type="password"
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">{{ __('auth.confirm_password_label') }}</label>
                <input
