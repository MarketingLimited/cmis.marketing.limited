{{-- Step 1: Connection Mode Selection - Partial Content --}}
@php
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-8 sm:px-8 sm:py-10 text-center border-b border-gray-100"
                ...
                <h1 class="text-2xl font-bold text-gray-900">
                    {{ __('wizard.mode.title', ['platform' => $displayName]) }}
                </h1>
                <p class="mt-2 text-gray-500">
                    {{ __('wizard.mode.subtitle', ['platform' => $displayName]) }}
                </p>
            </div>
            ...
            <div class="p-6 sm:p-8 space-y-6">
                                           ...
                                           :class="{ 'opacity-75 cursor-wait': connecting }">
                                            <template x-if="!connecting">
                                                <span class="flex items-center">
                                                    ...
                                                    {{ __('wizard.mode.direct.button', ['platform' => $displayName]) }}
                                                </span>
                                            </template>
                                            <template x-if="connecting">
                                                <span class="flex items-center">
                ...
                @if($config['supports_manual'] ?? false)
