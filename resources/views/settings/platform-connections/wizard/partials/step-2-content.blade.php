{{-- Step 2: Asset Selection - Partial Content --}}
@php
                ...
                <div class="flex items-center {{ $isRtl ? 'flex-row-reverse' : '' }}">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            {{ __('wizard.assets.subtitle', ['platform' => $displayName]) }}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            @else
                                ...
                                <div class="text-center py-8 border-2 border-dashed border-gray-200 rounded-xl">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">
                                        {{ __('wizard.assets.no_assets_description', ['type' => strtolower($assetName), 'platform' => $displayName]) }}
                                    </p>
                                </div>
                            @endif
                        </div>
