...
@section('title', __('Create Approval Workflow') . ' - ' . __('Settings'))
...
<div class="space-y-6">
    ...
    <form action="{{ route('orgs.settings.approval-workflows.store', $currentOrg) }}" method="POST" class="space-y-6"
          x-data="{
              steps: {{ json_encode(old('steps', [['role' => '', 'users' => [], 'required_approvals' => 1]])) }},
              addStep() {
