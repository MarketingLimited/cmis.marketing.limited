...
@section('content')
<div class="min-h-screen bg-gray-50" x-data="userSettingsPage()">
    <div class="max-w-5xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <nav class="text-sm text-gray-500 mb-2">
                ...
                <span class="text-gray-900">{{ __('User Settings') }}</span>
            </nav>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('User Settings') }}</h1>
            <p class="mt-2 text-gray-600">{{ __('Manage your personal account settings and preferences') }}</p>
        </div>
            ...
            <div class="lg:w-56 flex-shrink-0">
                <nav class="bg-white shadow rounded-lg overflow-hidden sticky top-6">
                    <div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
                        <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider">{{ __('User Settings') }}</h3>
                    </div>
                    ...
                    <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
                        <a href="{{ route('orgs.settings.organization', $currentOrg) }}" class="flex items-center text-sm text-gray-600 hover:text-indigo-600">
