        ...
        <div class="bg-white shadow-sm rounded-lg">
            ...
            <div class="px-6 py-5 space-y-5">
                <div>
                    <x-timezone-select
                        name="timezone"
                        :value="old('timezone', $profileGroup->timezone ?? $organization->timezone ?? 'UTC')"
                        :label="__('Timezone')"
                        :required="false"
                        :showInheritance="true"
                        :inheritedFrom="__('Organization')"
                        :inheritedValue="$organization->timezone ?? 'UTC'"
                        :helpText="__('Leave empty to inherit from organization timezone. Currently: ' . ($profileGroup->timezone ?? 'inherited from organization'))"
                    />
                </div>
