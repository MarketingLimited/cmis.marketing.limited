        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '{{ $isRtl ? 'translate-x-full' : '-translate-x-full' }}'"
            ...
            <div class="flex items-center justify-between h-16 px-4 border-b border-slate-700/50">
                <div class="flex items-center gap-3" x-show="!compactMode" x-transition>
                    <img src="{{ asset('images/logo-icon.png') }}" alt="CMIS Logo" class="w-12 h-12 object-contain">
                    <div>
            ...
            <nav class="px-3 py-2 overflow-y-auto h-[calc(100vh-14rem)] pb-20 custom-scrollbar overscroll-contain">
                ...
                <!-- Dynamic Navigation Items (from Marketplace Apps) -->
                <x-admin-nav-items :current-org="$currentOrg" :is-rtl="$isRtl" />
