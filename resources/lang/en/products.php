...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Products Language Lines (English)
    |--------------------------------------------------------------------------
    |
    | English translations for product management pages
    |
    */
    ...
    // Help Text
    'help' => [
        'product_name' => 'Enter a descriptive name for the product',
        'sku' => 'Unique product identifier (optional)',
        'price' => 'Price in local currency',
        'stock' => 'Available quantity in stock',
        'category' => 'Select product category for better organization',
    ],
