...
- Verify organization switching UI
- Test RLS isolation visually (different org data)
- Screenshot tenant-specific dashboards
- Validate multi-org data separation in UI
