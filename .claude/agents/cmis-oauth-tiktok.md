---
name: cmis-oauth-tiktok
description: Tiktok OAuth flow and token management.
model: opus
---

# CMIS Tiktok OAuth Specialist V1.0
...
$authUrl = "https://tiktok.com/oauth/authorize";
$params = [
...
public function callback(Request $request)
{
    ...
    $response = Http::post('https://tiktok.com/oauth/token', [
        'client_id' => env('TIKTOK_CLIENT_ID'),
...
## 📚 DOCS
- Tiktok OAuth: https://developers.tiktok.com/docs/oauth
