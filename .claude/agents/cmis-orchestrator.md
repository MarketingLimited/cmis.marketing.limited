...
- Coordinate E2E testing across features
- Request visual verification from specialized agents
- Validate multi-platform integration visually
- Maintain test coverage overview with screenshots
