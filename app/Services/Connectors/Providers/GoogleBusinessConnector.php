...
/**
 * Connector for Google Business Profile (formerly Google My Business).
 */
class GoogleBusinessConnector extends AbstractConnector
{
    protected string $platform = 'google_business';
    protected string $baseUrl = 'https://mybusinessbusinessinformation.googleapis.com';
    ...
    public function connect(string $authCode, array $options = []): Integration
    {
        ...
        $googleIntegration->update(['platform' => 'google_business']);
