...
/**
 * Connector for Microsoft Clarity Analytics.
 */
class ClarityConnector extends AbstractConnector
{
    protected string $platform = 'clarity';
    protected string $baseUrl = 'https://www.clarity.ms/api';
    protected string $apiVersion = 'v1';

    public function getAuthUrl(array $options = []): string
    {
        // Clarity uses API key
        return '';
    }
