...
class FacebookApiCommand extends Command
{
    ...
    protected $description = 'Execute Facebook API operations via Artisan (fetching posts, analytics, etc).';
    ...
    public function handle()
    {
        ...
        $this->warn('⚙️  FacebookService integration not yet implemented.');
