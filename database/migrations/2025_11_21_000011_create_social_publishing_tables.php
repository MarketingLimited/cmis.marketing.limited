...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('cmis.scheduled_posts')) {
            ...
            DB::statement("DROP POLICY IF EXISTS org_isolation ON cmis.scheduled_posts");
            DB::statement("
        ...
        if (!Schema::hasTable('cmis.platform_posts')) {
            ...
            DB::statement("DROP POLICY IF EXISTS org_isolation ON cmis.platform_posts");
            DB::statement("
        ...
        if (!Schema::hasTable('cmis.content_library')) {
            ...
            DB::statement("DROP POLICY IF EXISTS org_isolation ON cmis.content_library");
            DB::statement("
        ...
        if (!Schema::hasTable('cmis.publishing_queue')) {
            ...
            DB::statement("DROP POLICY IF EXISTS org_isolation ON cmis.publishing_queue");
            DB::statement("
        ...
        if (!Schema::hasTable('cmis.best_time_recommendations')) {
            ...
            DB::statement("DROP POLICY IF EXISTS org_isolation ON cmis.best_time_recommendations");
            DB::statement("
        ...
        DB::statement("
            CREATE VIEW cmis.v_publishing_performance AS
            SELECT
                sp.org_id,
                sp.post_id,
                sp.title,
        ...
        DB::statement("
            CREATE VIEW cmis.v_content_calendar AS
            SELECT
                sp.post_id,
                sp.org_id,
                sp.title,
