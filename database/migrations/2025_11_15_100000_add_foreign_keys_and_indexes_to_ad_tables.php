...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared('
            ...
            ALTER TABLE cmis.ad_sets
                ...
                FOREIGN KEY (integration_id, campaign_external_id)
                REFERENCES cmis.ad_campaigns(integration_id, campaign_external_id)
                ON DELETE CASCADE
                ON UPDATE CASCADE;
        ');
        ...
        DB::unprepared('
            ...
            ALTER TABLE cmis.ad_entities
                ...
                FOREIGN KEY (integration_id, adset_external_id)
                REFERENCES cmis.ad_sets(integration_id, adset_external_id)
                ON DELETE CASCADE
                ON UPDATE CASCADE;
        ');
    ...
    {
        // Drop Foreign Keys
        DB::unprepared('ALTER TABLE cmis.ad_campaigns DROP CONSTRAINT IF EXISTS fk_ad_campaigns_org CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_campaigns DROP CONSTRAINT IF EXISTS fk_ad_campaigns_integration CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_accounts DROP CONSTRAINT IF EXISTS fk_ad_accounts_org CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_accounts DROP CONSTRAINT IF EXISTS fk_ad_accounts_integration CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_sets DROP CONSTRAINT IF EXISTS fk_ad_sets_org CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_sets DROP CONSTRAINT IF EXISTS fk_ad_sets_integration CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_sets DROP CONSTRAINT IF EXISTS fk_ad_sets_campaign CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_entities DROP CONSTRAINT IF EXISTS fk_ad_entities_org CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_entities DROP CONSTRAINT IF EXISTS fk_ad_entities_integration CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_entities DROP CONSTRAINT IF EXISTS fk_ad_entities_adset CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_metrics DROP CONSTRAINT IF EXISTS fk_ad_metrics_org CASCADE');
        DB::unprepared('ALTER TABLE cmis.ad_metrics DROP CONSTRAINT IF EXISTS fk_ad_metrics_integration CASCADE');

        // Drop Indexes
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_org_status');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_integration');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_org_created');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_external_id');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_provider_status');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_dates');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_campaigns_lookup');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_accounts_org');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_accounts_integration');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_accounts_external_id');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_accounts_status');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_org');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_integration');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_campaign');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_external_id');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_status');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_sets_dates');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_entities_org');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_entities_integration');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_entities_adset');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_entities_external_id');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_entities_status');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_metrics_org_date');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_metrics_integration_date');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_metrics_entity_date');
        DB::unprepared('DROP INDEX IF EXISTS cmis.idx_ad_metrics_aggregation');
        DB::unprepared('DROP INDEX IF EXISTS cmis.uniq_ad_campaigns_external');
        DB::unprepared('DROP INDEX IF EXISTS cmis.uniq_ad_accounts_external');
        DB::unprepared('DROP INDEX IF EXISTS cmis.uniq_ad_sets_external');
        DB::unprepared('DROP INDEX IF EXISTS cmis.uniq_ad_entities_external');
    }
};
