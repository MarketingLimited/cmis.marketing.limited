...
-- DUPLICATE REMOVED: operations.audit_trigger_function() already defined at line 2713
-- This duplicate definition was causing migration errors


-- =============================================================================
-- DUPLICATE SECTION REMOVED
-- =============================================================================
-- The following duplicate function definitions were removed (2024-11-23):
-- - cmis.audit_creative_changes() (duplicate of line 20)
-- - cmis.auto_refresh_cache_on_field_change() (duplicate of line 51)
-- - cmis.prevent_incomplete_briefs_optimized() (duplicate of line 816)
-- - cmis.refresh_permissions_cache() (duplicate of line 879)
-- - cmis.update_updated_at_column() (duplicate of line 1155)
-- - operations.audit_trigger_function() (duplicate of line 2713)
-- - Plus 5 more duplicate functions
--
-- Total: ~206 lines of duplicate code removed
-- =============================================================================
